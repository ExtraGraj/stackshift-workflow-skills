...
1. Append the registry entry to `.stackshift/protocols/_registry.json` (`tier: "optional"`, `file: "auto-verify-hook.md"`).
2. Copy `protocols/auto-verify-hook.md` from the skill bundle to `.stackshift/protocols/`.
